...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 overflow-hidden bg-neutral-900">
      ...
      {/* Background Overlay to ensure text readability in Light and Dark Mode */}
      ...
      <div className="relative z-30 w-full max-w-[450px] transition-all duration-300">
        ...
        {/* Clean, Translucent Login Card Container */}
        <div className="bg-black/40 dark:bg-zinc-950/50 light:bg-white/75 border border-white/10 dark:border-zinc-800/60 light:border-neutral-200/80 rounded-3xl p-8 sm:p-11 shadow-2xl backdrop-blur-2xl ring-1 ring-white/5">
          <div className="mb-8">
            ...
            <p className="mt-2 text-xs font-medium text-zinc-400 dark:text-zinc-400 light:text-neutral-500 leading-normal">
              Hospital Staff Attendance & Workforce Management
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Form Actions (Sign In & Forgot Password) */}
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-center justify-end">
                <Link
                  ...
                  className="text-[10px] font-black text-zinc-400 hover:text-emerald-400 light:text-neutral-500 light:hover:text-emerald-600 transition-colors uppercase tracking-widest outline-none"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/5 dark:border-zinc-800/60 light:border-neutral-200/60 text-center">
            <p className="text-xs font-medium text-zinc-400 dark:text-zinc-500 light:text-neutral-500">
              First time deploying MediTrack?{" "}
              <Link
                href="/register"
                className="text-emerald-400 light:text-emerald-600 font-black hover:underline ml-1 uppercase tracking-wider outline-none"
              >
